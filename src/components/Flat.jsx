...
// API KEY 8354525eb408dd7514741e74774c2697
function Flat() {
    ...
    useEffect(() => {
        if(city !== "") {
            axios.get(`https://api.openweathermap.org/data/2.5/find?q=${city}&units=metric&appid=8354525eb408dd7514741e74774c2697`)
